...
const brave = shuffle(['brave.habits', 'brave.homer', 'brave.love', 'brave.neighbour'])
const circus = shuffle(['circus.ajax', 'circus.brother', 'circus.people', 'circus.whisky'])
...
export async function niketaTheme() {
  ...
  const MODES = maybe(darkModeEnv, MODES_DARK, MODES_LIGHT)
